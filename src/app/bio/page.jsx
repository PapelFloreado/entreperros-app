  ...
  return (
    <>
        <div className="container sm:container md:mx-auto xl:container md:min-h-screen">
          <h1 className='md:text-4xl text-2xl my-4 md:text-start text-center '>Conocemos un poco más</h1>
          <h3 className="md:text-start text-center mt-10 mb-16">Te dejamos una breve reseña</h3>
          ...
          <div className="mt-14 lg:mx-auto mx-10">
